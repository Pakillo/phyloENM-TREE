...
## R code for 'Comparison of splitting, lumping, partial pooling, and phylogenetically-informed pooling on a simulated dataset' (*Box 3*)
...
Rodríguez-Sánchez F. 2018. R code for comparing splitting, lumping, partial pooling, and phylogenetically-informed ecological niche models. Zenodo. DOI: 
